...
label = np.load('MT-STNet-YINCHUAN.npz', allow_pickle=True)['truth']     #前面有一个真实值了 这里是什么意思，没用到
...
plt.subplot(2,3,6)
plt.scatter(LABEL_obs,MT_STNet_pre,alpha=0.7,color='dimgray',edgecolor = "black",marker='o',label=u'MT_STNet',linewidths=1)
a=[i for i in range(300)]
b=[i for i in range(300)]
plt.plot(a,b,'black',linewidth=2)
