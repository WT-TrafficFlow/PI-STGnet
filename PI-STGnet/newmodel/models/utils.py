...
def construct_feed_dict(xs =None, labels =None, xs_all =None, day_of_week=None, minute_of_day=None, poi=None, adj=None, placeholders=None, sites=30, is_traning=True):
    ...
    feed_dict.update({placeholders['features_poi']: poi})
    if adj:
