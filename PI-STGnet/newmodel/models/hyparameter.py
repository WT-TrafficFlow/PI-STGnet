...
class parameter(object):
    def __init__(self,parser):
        ...
        self.parser.add_argument('--model_name', type=str, default='PIRIN', help='training or testing model name')   #STGIN_1语义增强消融
        self.parser.add_argument('--file_train_s', type=str, default='data/ND5/train_MFD_5min.csv', help='training_speed file address')
        self.parser.add_argument('--file_adj', type=str,default='data/ND5/adjacent.csv', help='adj file address')
        self.parser.add_argument('--site_num', type=int, default=30, help='total number of road')
        ...
        self.parser.add_argument('--dropout', type=float, default=0.3, help='drop out')       #调参
        ...
        self.parser.add_argument('--los_rate', type=float, default=0.3, help='speed loss weight')

        #每个点表示a->b路线，目前8个收费站
        self.parser.add_argument('--emb_size', type=int, default=64, help='embedding size')   #调参
        self.parser.add_argument('--features', type=int, default=2, help='numbers of the feature')
        self.parser.add_argument('--type_poi', type=int, default=5, help='numbers of the poi type')
        ...
        self.parser.add_argument('--hidden_layer', type=int, default=1, help='hidden layer')   #调参
